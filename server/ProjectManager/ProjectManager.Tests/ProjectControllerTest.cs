...
namespace ProjectManager.Test
{
    ...
    public class ProjectControllerTest
    {
        ...
        public void TestUpdateProjects_Success()
        {
            ...
            users.Add(new DAC.User()
            {
                Employee_ID = 244789.ToString(),
                First_Name = "TEST PROJECT",
                Last_Name = "TEST PROJECT 1",
                Project_ID = 123,
                Task_ID = 123,
                User_ID = 123
            });
            ...
            Assert.IsNotNull(result);
            Assert.AreEqual((context.Projects.Local[0]).Project_Name.ToUpper(), "TEST PROJECT 2");
        }
